#ifndef __S3PRACTICE_SCENE_H__
#define __S3PRACTICE_SCENE_H__
...
class  S3PracticeScene: public cocos2d::CCLayer, public cocos2d::extension::CCTableViewDataSource, public cocos2d::extension::CCTableViewDelegate
{
public:
